...
class Model_Finder:
    ...
    def get_random_forest(self, train_x, train_y):
        ...
        #self.param_grid = {"n_estimators": [50], "criterion": ['entropy'],
                               #"max_depth": [4], "max_features": ['auto']}
        
        self.RFestimator = RandomForestClassifier()
        self.grid = GridSearchCV(estimator=self.RFestimator, param_grid=self.param_grid, cv=5,  verbose=3)
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        if(self.random_forest_score <  self.xgboost_score):
            return 'XGBoost',self.xgboost, self.random_forest_score, self.xgboost_score
        else:
            return 'RandomForest',self.random_forest, self.random_forest_score, self.xgboost_score
